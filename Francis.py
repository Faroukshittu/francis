...
__author__ = 'Mr-FAROUK'
__copyright = 'All rights reserved . Copyright  Mr-FAROUK'
...
def reg():
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+2348033717655')
        reg()
...
def a_s():
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92mDADA MEAN MR-F)FAROUK PROGRAMMING'
